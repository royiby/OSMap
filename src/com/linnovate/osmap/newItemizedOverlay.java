...
public class newItemizedOverlay<T extends OpenStreetMapViewOverlayItem> extends OpenStreetMapViewItemizedOverlay<T> {
        ...
        protected void onDrawFinished(Canvas c, OpenStreetMapView osmv) {
                if(this.mFocusedItemIndex != NOT_SET){
                        ...
                        c.drawRoundRect(new RectF(descBoxLeft-3, descBoxTop-3, descBoxRight+3, descBoxBottom+3), DESCRIPTION_BOX_CORNERWIDTH, DESCRIPTION_BOX_CORNERWIDTH, this.mDescriptionPaint);//this.mMarkerBackgroundPaint);
                        
                        this.mMarkerBackgroundPaint.setColor(Color.YELLOW);//XXX - the background color for the sign!
                        c.drawRoundRect(new RectF(descBoxLeft - 1, descBoxTop - 1, descBoxRight + 1, descBoxBottom + 1), DESCRIPTION_BOX_CORNERWIDTH, DESCRIPTION_BOX_CORNERWIDTH, this.mMarkerBackgroundPaint);//this.mDescriptionPaint);
